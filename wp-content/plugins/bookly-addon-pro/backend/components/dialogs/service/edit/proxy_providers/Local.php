...
class Local extends Proxy\Pro
{
     ...
     * @inheritDoc
     */
    public static function getAdvancedHtml( $service )
    {
        ...
        return self::renderTemplate( 'advanced_settings', compact( 'service', 'min_time_prior_cancel', 'min_time_prior_booking' ), false );
    }
