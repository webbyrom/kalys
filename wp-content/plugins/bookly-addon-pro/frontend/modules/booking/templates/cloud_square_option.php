...
<div class="bookly-box bookly-list">
    <label>
        <input type="radio" class="bookly-payment bookly-js-checkout" name="payment-method-<?php echo $form_id ?>" value="cloud_square"/>
    ...
    <?php if ( is_array( $payment_status ) &&  $payment_status['gateway'] == Payment::TYPE_CLOUD_SQUARE && $payment_status['status'] == 'error' ) : ?>
