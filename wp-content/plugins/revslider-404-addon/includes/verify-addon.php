...
class Revslider_404_Addon_Verify {
	
	private $notice = false,
			$min_rev_slider = '6.0',
			$addon_title = '404 Page',
			$text_domain = 'revslider-404-addon',
			$notice_slug = 'revslider_404_addon';
	...
	public function enqueue_notice_script() {
		...
		wp_enqueue_script($this->text_domain . '-notice', REV_ADDON_404_URL . 'admin/assets/js/dismiss-admin-notice.js', array('jquery'), REV_ADDON_404_VERSION, true);
