...
class Revslider_Maintenance_Addon_Verify {

	private $notice = false,
			$min_rev_slider = '6.0',
			$addon_title = 'Coming Soon & Maintenance',
			$text_domain = 'revslider-maintenance-addon',
			$notice_slug = 'revslider_maintenance_addon';
	...
	public function enqueue_notice_script() {
		...
		wp_enqueue_script($this->text_domain . '-notice', REV_ADDON_MAINTENANCE_URL . 'admin/assets/js/dismiss-admin-notice.js', array('jquery'), REV_ADDON_MAINTENANCE_VERSION, true);
